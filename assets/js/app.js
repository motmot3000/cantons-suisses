...
function showSuccess() {
    ...
    // Animation de l'info-section en vert
    infoSection.classList.remove("error-state");
    infoSection.classList.add("success-state");
    ...
    setTimeout(() => {
        ...
        infoSection.classList.remove("success-state");
    }, 1200);
...
function showError(wrongAnswer) {
    ...
    // Animation de l'info-section en rouge
    infoSection.classList.remove("success-state");
    infoSection.classList.add("error-state");
...
function resetVisualState() {
    ...
    infoSection.classList.remove("success-state", "error-state");
}
